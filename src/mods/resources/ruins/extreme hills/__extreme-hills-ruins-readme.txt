...
*\.minecraft\mods\resources\ruins\extreme hills

EXTREME HILLS:
This is a work-in-progress collection of structures (ruined, abandoned, or in fairly decent shape) to be found mostly in extreme hills biomes (though with the biomesToSpawnIn setting left as-is, they may pop up elsewhere as well).
